...
<?php include("menubaradmin.php")?>
	...
	<h1>Voir tous les détails des animeaux de compagnie </h1>
	<form method="post">
	<input type="text" name="search" placeholder="entrez le nom recherchez..." style="margin-left:60px;margin-top:10px;border-radius:4px;border:1px solid aquamarine;width:300px;height:40px;padding-left:5px;font-size:20px;">
	<input type="submit" name="search_btn" value="Recherche" style="background:#fff;margin-left:10px;margin-top:10px;border-radius:4px;border:1px solid aquamarine;width:100px;height:40px;font-size:20px;">
	</form>
	<table>
<tr>
<th>Code</th>
...
<th>Supprimer</th>
	...
	<th>Tarif</th>
	<th>Mot clé</th>
	<th>Obeservation 1</th>
	<th>Obeservation 2</th>
	<th>Photos</th>
	<th>Nourriture</th>
...
<?php
			...
			echo"<tr><td>".$i++."</td>
			<td><a href='edit_petdetils.php?id=".$row['pet_id']."'>Modifier</td>
				
				<td><a href='delete_petdetils.php?id=".$row['pet_id']."'>Supprimer</td>
