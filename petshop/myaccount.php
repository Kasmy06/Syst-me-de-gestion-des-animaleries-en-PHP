...
<body>
<a href="index.php" style="color:red;font-size:20px;">Page Accueil</a>
<?php
	...
	echo"<h1 style='color:#fff;background:#425298;text-align:center;line-height:50px;height:50px;'>Votre adress</h1>";
		echo"<div id='box1'>";
		...
		echo"<h2>".$row['phoneno']."</h2><br><a href='edit_address.php?userid=".$row['id']."'><input type='submit' value='Modifier' style='margin-bottom:20px;width:70px;height:40px;border-radius:4px;background:#fff;border:1px solid aquamarine;'></a>";
...
?>
					<div id="show">
						<h1 style="color:#fff;background:#425298;text-align:center;line-height:50px;height:50px;">Vos commandes</h1>
