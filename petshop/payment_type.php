...
<h1 style="width:100%;height:40px;line-height:40px;background:#425298;color:#fff;text-align:center;margin-top:20px;border-radius:4px;text-shadow: 5px 5px 5px #000;box-shadow: 3px 3px 3px #000;">Select payment Method</h1>
	...
	<input type="submit" name="payment" value="select paiement" style="width:150px;height:40px;border:1px solid #425298;border-radius:4px;margin-left:20px;background:#fff;margin-top:100px;">
		</form>
		</div>
</body>
</html>
<?php
	...
	if(isset($_POST['payment']))
	{
		...
		if($getvalue=='select')
		{
			echo"<script>alert('Sélectionner une méthode')</script>";
		}
		if($getvalue=='cod')
		{
