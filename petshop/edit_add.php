		...
		if(isset($_COOKIE['usernameget']))
				{
					...
					echo"<div id='showadd'>
						<h1 style='width:100%;height:40px;line-height:40px;background:#425298;color:#fff;text-align:center;margin-top:20px;border-radius:4px;text-shadow: 5px 5px 5px #000;box-shadow: 3px 3px 3px #000;'>Modifier l'adresse</h1>
...
?>
		<form method="post">
			...
			<br><input type="submit" name="upadd" value="Modifier" style="width:150px;height:40px;border:1px solid #425298;border-radius:4px;margin-left:300px;background:#fff;">
		</form>
		</div>
