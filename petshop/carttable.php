<html>
<head>
	<title>Gestion des animaleries</title>
		...
		<body>
				...
				include("db.php");
						...
						echo"<tr>
							...
							<td><a href='removecart.php?cart_id=$getcartid'>Supprimer</a></td>
							<td> $a Francs</td>
				...
				?>
				<tr><td colspan="6" style="text-align:right;border-top:1px solid #400040;"><b style="color:red;font-size:25px;">Total</b></td><td style="border-top:1px solid #400040;border-bottom:1px solid #400040;">  <?php echo"".$b."";?> Francs</td></tr>
				</table>
				<a href="deliveryaddress.php" style="margin-left:400px;border:1px solid #425298;padding:10px;text-decoration:none;">Commander</a>
	...
	if(isset($_GET['upqty']))
	{
		include("db.php");
			...
			if($qty<=10)
			{
					...
					if($query->execute())
					{
						echo"<script>alert('Mise ajour réussi')</script>";
