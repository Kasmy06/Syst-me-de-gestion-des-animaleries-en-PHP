...
if(isset($_POST['clickk']))
{
	...
	if(isset($_POST['login']))
	{
		...
		if($a==1)
		{
			echo "<h1>Nom et mot de passe inxorrecte</h1>";
		}
	}
...
body{	
	...
	<div class="container">
		<img src="w.jpg">
				<form  method="post">
						<input type="text" name="email" id="email" required placeholder="&#x263A; votre nom" ><br><br>
						<input type="password" name="password" id="pass" required placeholder="&#x263A; votre mot de passe" ><br><br>
						
						
						<input type="checkbox" name="remember" value="1"><b style="color:#fff;">se souvenir de moi</b><br/>
						<input type="submit" name="login" value="Validez &#x27A8;" class="btn-login"><br/><br/>
						<button id="clr"  name="clickk"></button>

					<br>
						<a style="text-decoration:none;" href="newuser.php"><input   type="button"   value="&#x263B;Nouveau"  class="btn-newuser" ></a>
