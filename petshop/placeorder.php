...
?>
	<div id="show">
	<h1 style="width:100%;height:40px;line-height:40px;background:#425298;color:#fff;text-align:center;margin-top:20px;border-radius:4px;text-shadow: 5px 5px 5px #000;box-shadow: 3px 3px 3px #000;">Détail de la commande</h1>
				<table>
				<tr>
					<th>S.No</th>
					<th>Nom</th>
				...
				<td style="border-top:1px solid #400040;border-bottom:1px solid #400040;"> <b style="font-size:20px;"> <?php echo"".$b."";?> Francs</b></td></tr>
		<tr><td colspan="5">Mode de paiement: <?php echo"".$_GET['method']."";?></td></tr>	
<tr><td colspan="5"><form method="post"><input type="submit" name="place" value="Passer la commande" style="padding:10px;border:1px solid #425298;color:#425298;background:#fff;border-radius:4px;"></form></td></tr>			
		</table>
	</div>
		<div id="show">
			
		<h1 style="width:95%;text-align:center;background:#425298;color:#fff;height:50px;line-height:50px;margin-left:30px;margin-top:10px;border-radius:4px;margin-bottom:10px;">Détail de la commande  </h1>
				<table>
				<tr>
					<th>S.No</th>
					<th>Nom</th>
				...
				<?php
						...
						echo"<tr>
							...
							<td> ".$row2['pet_rate']." Francs</td>
							<td><b>".$row1['qty']." </b><form method='get'><input type='text' name='qty' value='".$row1['qty']."' style='width:40px;height:20px;'><input type='hidden' name='cart_id' value='".$row1['cart_id']."' style='width:40px;height:20px;'><input type='submit' name='upqty' value='Ajou' style='width:40px;height:20px;background:#fff;color:#400040;border:1px solid #400040;margin-left:10px;'></form></td>
							<td><a href='placeorder_removepets.php?cart_id=$getcartid'>Modifier</a></td>
							<td>$a Francs</td>
