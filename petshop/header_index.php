...
<div id="header">
	...
	<h1>Sopping des animaux de compagnie</h1>
	...
	if(!isset($_COOKIE['usernameget']))
				{
					echo"<li><a href='login_pet.php'>Connectez-vous</a></li>
					<li><a href='newuser.php'>Nouveau utilisateur</a></li>";
				}
				...
				if(isset($_COOKIE['usernameget']))
				{
					...
					echo"<li><a href='logout.php'>Déconnexion</a></li>
						<li><a href='myaccount.php'>Compte</a></li>
							<li><a href='carttable.php'>Panier(<b style='color:yellow;'>$rcount</b>)</a></li>";
				}
	...
	if(isset($_COOKIE['usernameget']))
				{
						echo"<h2 style='border-radius:4px;padding:10px;float:right;margin-right:-310px;margin-top:35px;color:#fff;border:1px solid aquamarine;'>Bienvenue ".$_COOKIE['usernameget']."</h2>";
				}?>
				<form method="post">
