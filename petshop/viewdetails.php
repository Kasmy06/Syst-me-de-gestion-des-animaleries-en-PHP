...
<h1 style="text-shadow: 5px 5px 5px #000;box-shadow: 3px 3px 3px #000;margin-top:5px;width:95%;height:40px;line-height:40px;background:#425298;color:#fff;text-align:center;margin-left:20px;padding-left:10px;border-radius:4px;border:1px solid aquamrine;"><?php echo"".$row['pet_name']."";?></h1>
		...
		<div id="pet2">
		<ul>
				<li>Type d'animal:  <?php echo"".$row['pet_type']."";?></li>
				<li style="margin-left:110px;">couleur :  <?php echo"".$row['pet_color']."";?></li>
		<li style="margin-left:150px;">Tarif:  <?php echo"".$row['pet_rate']."";?></li>
		
		<li style="margin-left:150px;">Caractéristique:  <?php echo"".$row['pet_features1']."";?></li>
		
		<li style="margin-left:20px;margin-top:20px;">Caractéristique:  <?php echo"".$row['pet_features2']."";?></li>
		<li style="margin-left:100px;margin-top:30px;"><a href="addtocart.php?id=<?php echo"".$row['pet_id']."";?>" style="width:100px;height:40px;background:#fff;color:#400040;border:1px solid #400040;text-decoration:none;padding:10px;">Ajouter au panier</a></li>
		</ul>
			</form></div><br><br>
		<?php
		...
		while($row1=$query->fetch()):
			...
			echo"<ul>
				<li><a href='viewdetails.php?id=".$row1['pet_id']."'>
					...
					<h1 style='text-align:center;font-size:20px;font-weight:normal;margin-top:10px;'>Prix (".$row1['pet_rate']." francs.)</h1>
				</a></li>
			</ul>";
