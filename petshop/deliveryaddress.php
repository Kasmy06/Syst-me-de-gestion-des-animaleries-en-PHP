		...
		if(isset($_COOKIE['usernameget']))
				{
					...
					echo"<div id='showadd'>
						<h1 style='width:100%;height:40px;line-height:40px;background:#425298;color:#fff;box-shadow: 3px 3px 3px #000;text-align:center;border-radius:4px;text-shadow: 5px 5px 5px #000;margin-top:20px;'>Livraison à cette adresse</h1>
						<li style='text-align:center;margin-top:60px;font-size:30px;'>".$row['address']."</li>
						<li style='margin-top:130px;'><a href='edit_add.php' style='margin-left:450px;border:1px solid #425298;padding:10px;text-decoration:none;border-radius:4px;'>modifier </a></li>
